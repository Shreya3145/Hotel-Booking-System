...
function saveMessage(name, email, persons, roomtype, phone, payment, checkin, checkout, message) {
    var newMessageRef = (0, _database.push)(messagesRef);
    const newMsgRef = (0, _database.push)(messagesRef);
    (0, _database.set)(newMsgRef, {
        name,
        email,
        persons,
        roomtype,
...
},{}]},["n0fw4","kTBnD"], "kTBnD", "parcelRequire2bad", {})

//# sourceMappingURL=Hotel Booking Form.3c14d121.js.map
